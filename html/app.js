    ...
    case "management":
      ...
      if (!jQuery.isEmptyObject(btnList[btnList.pd.label])) {
        ...
        for (const [key] of Object.entries(btnList[btnList.pd.label])) {
          ...
          mainMenuNavButtons += `<div class="mainMenuNavSubButtonItem" id="${key}"><button class="mainMenuNavSubButton actionButton" data-btnid="mainMenuNavButton" data-type="employees" data-btype="manageStaff" data-citid="${key}" data-action="bossSubMenu" data-effect="leftRight" data-element="#subMenuContainer" data-target="sub" data-targetid="${btnCnt}"><i class="${btnList.icons[btnList.pd.label]}"></i>${btnList[btnList.pd.label][key].personal.firstName} ${btnList[btnList.pd.label][key].personal.lastName}${title}</button></div>`;
          btnCnt++
        };
        mainMenuNavButtons += "</div></div>";
        btnCnt++;
      ...
      if (!jQuery.isEmptyObject(btnList[btnList.pd.pastLabel])) {
        mainMenuNavButtons += `<div class="mainMenuNavButtonItem"><button class="mainMenuNavButton actionButton" data-btnid="mainMenuNavButton" data-btnid="mainMenuNavButton" data-action="navButton" data-targetID="empty" data-target="TempMain" data-effect="upDown" data-element="#nav${btnCnt}"><i class="${btnList.icons[btnList.pd.pastLabel]}"></i>${btnList.menu.text[btnList.text[btnList.pd.pastLabel]]}</button><div id="nav${btnCnt}" class="mainMenuNavSubButtons">`;
        for (const [key] of Object.entries(btnList[btnList.pd.pastLabel])) {
          mainMenuNavButtons += `<div class="mainMenuNavSubButtonItem" id="${key}"><button class="mainMenuNavSubButton actionButton" data-btnid="mainMenuNavSubButton" data-type="pastEmployees" data-btype="manageStaff" data-citid="${key}" data-action="bossSubMenu" data-effect="leftRight" data-element="#subMenuContainer" data-target="sub" data-targetid="${btnCnt}"><i class="${btnList.icons[btnList.pd.pastLabel]}"></i>${btnList[btnList.pd[btnList.pd.pastLabel]][key].personal.firstName} ${btnList[btnList.pd.pastLabel][key].personal.lastName}</button></div>`;
          btnCnt++
        };
        mainMenuNavButtons += "</div></div>";
        btnCnt++;
    ...
    case "multiJob":
      ...
      if (!jQuery.isEmptyObject(btnList.gangs.hired)) {
        ...
        for (const [key, value] of Object.entries(btnList.gangs.hired)) {
          ...
          if (value.active === true) {status = `<button class="mainMenuContentActive"><i class="${btnList.icons.active}"></i>Active</span>`}
          mainMenuNavButtons += `<tr class="mainMenuNavSubButtonItem" id="${key}"><td>${status}<br /><button class="mainMenuContentButtonQuit actionButton" data-action="multiJob" data-type="multijob" data-btype="quit" data-gang="${value.name}"><i class="${btnList.icons.quit}"></i>Quit</button></td><td>${value.label}</td></tr>`;
        };
        mainMenuNavButtons += "</table></div></div>";
      }
      status = "";
  ...
  switch(action) {
    ...
    case "management":
      ...
      if (data.btype == "manageStaff") {
        ...
        if(!history[btnList[btnList.pd.current]].rehireable){subMenuNavButtons += `<h3 class="blackListed">-- DO NOT HIRE --<br />Black Listed</h3>`;}
        data.header = `${personal.firstName} ${btnList[data.type][data.citid].personal.lastName}`;
        subMenuNavButtons = `<div class="subMenuNavButtons">`
        btnCnt++;
        subMenuNavButtons += `<div class="subMenuNavButtonItem"><button class="subMenuNavButton actionButton" data-btnid="subMenuNavButton" data-job="${btnList[btnList.pd.current]}" data-ctype="personal" data-type="${data.type}" data-citid="${data.citid}" data-action="bossContent" data-effect="leftRight" data-element="#contentContainer" data-target="con" data-targetid="${btnCnt}"><i class="${btnList.icons.personal}"></i>Personal Details</button></div>`;
        btnCnt++
        subMenuNavButtons += `<div class="subMenuNavButtonItem"><button class="subMenuNavButton actionButton" data-btnid="subMenuNavButton" data-job="${btnList[btnList.pd.current]}" data-ctype="rapSheet" data-type="${data.type}" data-citid="${data.citid}" data-action="bossContent" data-effect="leftRight" data-element="#contentContainer" data-target="con" data-targetid="${btnCnt}"><i class="${btnList.icons.rapSheet}"></i>Rap Sheet</button></div>`;
        btnCnt++
        subMenuNavButtons += `<div class="subMenuNavButtonItem"><button class="subMenuNavButton actionButton" data-btnid="subMenuNavButton" data-action="navButton" data-targetID="empty" data-target="TempSub" data-effect="upDown" data-element="#navSub${btnCnt}" data-id="${btnCnt}"><i class="${btnList.icons[btnList.pd.current]}"></i>${btnList[btnList.pd.currentName]} Record</button><div id="navSub${btnCnt}" class="subMenuNavSubButtons">`;
        btnCnt++;
        subMenuNavButtons += `<div class="subMenuNavSubButtonItem"><button class="subMenuNavSubButton actionButton" data-btnid="subMenuNavSubButton" data-job="${btnList[btnList.pd.current]}" data-ctype="history" data-type="${data.type}" data-citid="${data.citid}" data-action="bossContent" data-effect="leftRight" data-element="#contentContainer" data-target="con" data-targetid="${btnCnt}"><i class="${btnList.icons[btnList.pd.current]}"></i>Stats</button></div>`;
        btnCnt++;
        subMenuNavButtons += `<div class="subMenuNavSubButtonItem"><button class="subMenuNavSubButton actionButton" data-btnid="subMenuNavSubButton" data-job="${btnList[btnList.pd.current]}" data-ctype="awards" data-type="${data.type}" data-citid="${data.citid}" data-action="bossContent" data-effect="leftRight" data-element="#contentContainer" data-target="con" data-targetid="${btnCnt}"><i class="${btnList.icons[btnList.pd.current]}"></i>Awards</button></div>`;
        btnCnt++;
        subMenuNavButtons += `<div class="subMenuNavSubButtonItem"><button class="subMenuNavSubButton actionButton" data-btnid="subMenuNavSubButton" data-job="${btnList[btnList.pd.current]}" data-ctype="reprimands" data-type="${data.type}" data-citid="${data.citid}" data-action="bossContent" data-effect="leftRight" data-element="#contentContainer" data-target="con" data-targetid="${btnCnt}"><i class="${btnList.icons[btnList.pd.current]}"></i>Reprimands</button></div>`;
        btnCnt++;
        subMenuNavButtons += `<div class="subMenuNavSubButtonItem"><button class="subMenuNavSubButton actionButton" data-job="${btnList[btnList.pd.current]}" data-ctype="notes" data-type="${data.type}" data-citid="${data.citid}" data-action="bossContent" data-effect="leftRight" data-element="#contentContainer" data-target="con" data-btnid="subMenuNavSubButton" data-targetid="${btnCnt}"><i class="${btnList.icons[btnList.pd.current]}"></i>Notes</button></div>`;
        btnCnt++;
        ...
        $.each(history, function(k,v){
          if(k != btnList[btnList.pd.current]) {
